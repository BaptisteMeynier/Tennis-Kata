...
class UmpireTest {
    ...
    void should_say_fifteen_when_player_wins_point_and_one_player_has_zero() {
        ...
        playerOne.winPoint();
        //THEN
        assertThat(umpire.announceScore(playerOne, playerTwo)).contains(StandardScore.FIFTEEN.value());
    }
    ...
    void should_say_player_one_win_when_player_one_wins_four_points_and_player_two_has_not_forty() {
        ...
        //THEN
        assertThat(umpire.announceScore(playerOne, playerTwo)).contains(StandardScore.WIN.value());
    }
    ...
    void should_say_deuce_when_player_one_and_two_have_forty() {
        ...
        //THEN
        assertThat(umpire.announceScore(playerOne, playerTwo)).contains(DeuceScore.DEUCE.value());
    }
    ...
    void should_say_advantage_player_one_when_players_were_deuce_and_player_wins_one_point() {
        ...
        playerOne.winPoint();
        //THEN
        assertThat(umpire.announceScore(playerOne, playerTwo)).contains(DeuceScore.ADVANTAGE.value()).contains(playerOne.getName());
    }
    ...
    void should_say_win_for_player_one_when_player_one_wins_two_points_after_deuce() {
        ...
        playerOne.winPoint();
        //THEN
        assertThat(umpire.announceScore(playerOne, playerTwo)).contains(DeuceScore.WIN.value()).contains(playerOne.getName());
    }
}